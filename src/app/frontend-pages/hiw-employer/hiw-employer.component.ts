...
@Component({
  selector: 'app-hiw-employer',
  templateUrl: './hiw-employer.component.html',
  styleUrls: ['./hiw-employer.component.css']
})
export class HiwEmployerComponent implements OnInit {
  loggedIn: boolean;
  usrtype: any;
  usernm: any;
  constructor(private commonService: CommonService) {
    ...
    this.commonService.changeMetaContent('hiw-Employer');
